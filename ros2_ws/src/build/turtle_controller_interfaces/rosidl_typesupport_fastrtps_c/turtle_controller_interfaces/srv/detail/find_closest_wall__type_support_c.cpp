...
#include "turtle_controller_interfaces/srv/detail/find_closest_wall__rosidl_typesupport_fastrtps_c.h"
...
using _FindClosestWall_Request__ros_msg_type = turtle_controller_interfaces__srv__FindClosestWall_Request;
...
size_t get_serialized_size_turtle_controller_interfaces__srv__FindClosestWall_Request(
  const void * untyped_ros_message,
...
static uint32_t _FindClosestWall_Request__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_turtle_controller_interfaces__srv__FindClosestWall_Request(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_turtle_controller_interfaces
size_t max_serialized_size_turtle_controller_interfaces__srv__FindClosestWall_Request(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = turtle_controller_interfaces__srv__FindClosestWall_Request;
    is_plain =
      (
...
static size_t _FindClosestWall_Request__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_turtle_controller_interfaces__srv__FindClosestWall_Request(
...
static message_type_support_callbacks_t __callbacks_FindClosestWall_Request = {
  "turtle_controller_interfaces::srv",
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, turtle_controller_interfaces, srv, FindClosestWall_Request)() {
...
using _FindClosestWall_Response__ros_msg_type = turtle_controller_interfaces__srv__FindClosestWall_Response;
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_turtle_controller_interfaces
size_t get_serialized_size_turtle_controller_interfaces__srv__FindClosestWall_Response(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _FindClosestWall_Response__ros_msg_type * ros_message = static_cast<const _FindClosestWall_Response__ros_msg_type *>(untyped_ros_message);
...
{
  return static_cast<uint32_t>(
    get_serialized_size_turtle_controller_interfaces__srv__FindClosestWall_Response(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_turtle_controller_interfaces
size_t max_serialized_size_turtle_controller_interfaces__srv__FindClosestWall_Response(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
...
static size_t _FindClosestWall_Response__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_turtle_controller_interfaces__srv__FindClosestWall_Response(
    full_bounded, is_plain, 0);
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, turtle_controller_interfaces, srv, FindClosestWall_Response)() {
...
// already included above
// #include "turtle_controller_interfaces/msg/rosidl_typesupport_fastrtps_c__visibility_control.h"
#include "turtle_controller_interfaces/srv/find_closest_wall.h"
...
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, turtle_controller_interfaces, srv, FindClosestWall)() {
