...
class Metaclass_FindClosestWall(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            import traceback
            logger = logging.getLogger(
                'turtle_controller_interfaces.srv.FindClosestWall')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
            ...
            from turtle_controller_interfaces.srv import _find_closest_wall
...
class FindClosestWall(metaclass=Metaclass_FindClosestWall):
    from turtle_controller_interfaces.srv._find_closest_wall import FindClosestWall_Request as Request
    from turtle_controller_interfaces.srv._find_closest_wall import FindClosestWall_Response as Response
